...
class _ComingSoonScreenState extends State<ComingSoonScreen> {
  ...
  Widget getBody() {
    return SingleChildScrollView(
      ...
      //     SizedBox(height: 20.0),
      //     // main image
      //     Consumer<ComingSoonMovieProvider>(
      //       builder: (context, provider, widget) {
      //         if (provider.getComingSoonMovieList() != null &&
      //             provider.getComingSoonMovieList().length > 0) {
      //           comingSoonMovieList = provider.getComingSoonMovieList();
      //           return Column(
      //             children: List.generate(comingSoonMovieList.length, (index) {
      //               return Padding(
      //                 padding: const EdgeInsets.all(8.0),
      //                 child: Column(
      //                   children: [
